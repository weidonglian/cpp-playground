...
struct DeadlineTimer {
  ...
  DeadlineTimer(int id, double expired_time) : id_(id), expired_time_(expired_time) {}
};
...
TEST_CASE("mutable_key", "[set]") {
  std::array<DeadlineTimer, 5> timers = {DeadlineTimer{0, 1.0}, DeadlineTimer{1, 2.0}, DeadlineTimer{2, 3.0},
